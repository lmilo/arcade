...
export const GAMES: GameEntry[] = [
  ...
  },
  {
    meta: {
      ...
      controls: 'Clic izq destapa · clic der marca',
      help: {
        rules: 'El tablero esconde minas. Cada casilla destapada muestra cuántas minas la rodean; con esas pistas deduces dónde NO hay minas.',
        howTo: 'Clic izquierdo destapa (la primera siempre es segura) y clic derecho pone/quita una bandera. En táctil, activa el modo 🚩 de arriba para marcar. Elige la dificultad antes de empezar.',
        win: 'Ganas al destapar todas las casillas sin mina; aparece el mensaje de victoria.',
        lose: 'Si destapas una mina, se revelan todas y pierdes.',
      },
    },
    sizes: ALL_SIZES,
    defaultSize: 'small',
    sizeLabels: { small: 'Fácil', normal: 'Medio', large: 'Difícil' },
  ...
  },
  {
    meta: {
      ...
      controls: 'Flechas / WASD / swipe',
      help: {
        rules: 'Lleva a la rana de abajo hasta arriba cruzando los carriles llenos de autos. La pantalla sube contigo (la barra de la derecha muestra cuánto te falta).',
        howTo: 'Muévete casilla por casilla con las flechas, WASD o swipe. Cada cruce suma un punto y el siguiente nivel tiene MÁS carriles: el cruce se vuelve más largo (no más rápido), así que cada punto cuesta más.',
        win: 'No tiene final: suma un cruce cada vez que llegas arriba, con recorridos cada vez más largos.',
        lose: 'Tienes 3 vidas: pierdes una si te atropella un auto (vuelves al inicio del cruce).',
      },
    },
  ...
  },
  {
    meta: {
      ...
      help: {
        ...
        howTo: 'Elige la dificultad (tamaño del tablero) antes de empezar y deduce el orden de toques para apagar todas las luces antes de que se acabe el tiempo. Resolver un tablero da más tiempo y sube de nivel.',
